...
If this is true, since $f_n(z)$ and $z$ are bounded on any compact set and $e^z$ is uniformly continuous, we can move limits through exponentiation to obtain $e^{f_n(z)}\to e^z$ uniformly.
