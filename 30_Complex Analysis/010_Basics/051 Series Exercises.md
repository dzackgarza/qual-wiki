...
&= {1\over 2}\Big[ 1 - \qty{{1\over 2\cdot 2!}z + {1\over 2\cdot 3!}z^2 + \bigo\qty{z^3} } \\ 
&\qquad + \qty{{1\over 2\cdot 2!}z + {1\over 2\cdot 3!}z^2 + \bigo\qty{z^3} }^2 \\ 
&\qquad + \qty{{1\over 2\cdot 2!}z + {1\over 2\cdot 3!}z^2 + \bigo\qty{z^3} }^3 \\
&\qquad - \bigo(z^4) \Big]\\
&= {1\over 2}\left[ 1 + z\qty{- {1\over 4}} + z^2\qty{} \right]
.\]
